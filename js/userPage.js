...
const experiencePostContainer =
  experienceModal.querySelector(".post-container");
...
const slideBox = skills.querySelectorAll(".slide-box")[1];
const skillItem = skills.querySelector(".skills-item");
